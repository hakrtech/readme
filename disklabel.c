...
struct space_allocation alloc_big[] = {
	...
	{  MEG(150),         GIG(2),   5, "/"		  }, /* 1 ->  2 */
	{   MEG(80),       MEG(256),  10, "swap"	  }, /* same size */
	{  MEG(120),         GIG(5),   8, "/tmp"	  }, /* 4 ->  5 */
	{   MEG(80),        GIG(10),  13, "/var"	  }, /* 4 -> 10 */
	{    GIG(2),         GIG(5),   5, "/usr"	  }, /* 2 ->  5 */
	{  MEG(512),         GIG(1),   3, "/usr/X11R6"	  }, /* same size */ 
	{    GIG(2),        GIG(10),  15, "/usr/local"	  }, /* same size */
	{    GIG(2),         GIG(4),   2, "/usr/src"	  }, /* 2 ->  4 */
	{    GIG(3),         GIG(6),   4, "/usr/obj"	  }, /* same size */ 
	{    GIG(2),         GIG(5),   0, "/usr/xobj"	  }, /* NEW x objects partition */
	{    GIG(2),         GIG(5),   0, "/usr/ports"	  }, /* NEW ports partition */
	{    GIG(1),         GIG(2),   0, "/usr/xenocara" }, /* min size 0.5 -> 1 */
	{    GIG(3),         GIG(5),   0, "/rel"	  }, /* NEW release partition   */ 
	{    GIG(1),       GIG(300),  35, "/home"	  }
			   /* total 300G + 65G */
